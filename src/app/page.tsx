  ...
  return (
    <>
      ...
      >
        ...
        <div
          aria-hidden="true"
          className="absolute inset-0 bg-gradient-to-br from-gf-red-dark/80 via-[#4a0000]/70 to-[#1a0000]/80"
        />
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 80% 50% at 50% 100%, rgba(183,28,28,0.4) 0%, rgba(127,0,0,0.15) 40%, transparent 70%)",
          }}
        />
      ...
      <section aria-label="Trust indicators" className="bg-white shadow-[0_4px_20px_rgba(0,0,0,0.06)]">
        <div className="max-w-6xl mx-auto px-6 py-12">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-0">
            <TrustItem
              icon={
                <svg className="w-8 h-8 text-gf-red" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {serviceAreas.map((area) => (
              <div key={area.name} className="group relative">
                ...
                <div
                  aria-hidden="true"
                  className="absolute top-0 left-0 right-0 h-1 rounded-t-xl bg-gradient-to-r from-gf-red to-gf-gold group-hover:from-gf-gold group-hover:to-gf-gold-light transition-all duration-500"
                />
                <ServiceAreaCard
                  name={area.name}
                  cities={area.cities}
      ...
      <section
        ...
        style={{
          background: "linear-gradient(170deg, #1a0000 0%, #3a0000 40%, #7f0000 100%)",
        }}
      >
        <div
          aria-hidden="true"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="mt-6 text-lg leading-relaxed text-white/80">
                From storefronts and restaurants to office parks and HOA communities, Go-Forth delivers
                professional-grade commercial holiday lighting that attracts customers and spreads holiday cheer.
              </p>

              <div className="mt-8 space-y-4">
                {[
                  { title: "Storefronts & Retail", desc: "Eye-catching displays that drive foot traffic and set the holiday mood for shoppers." },
                  { title: "Restaurants & Hospitality", desc: "Warm, inviting lighting for patios, entrances, and dining areas." },
                  { title: "Office Parks & HOAs", desc: "Coordinated designs for multi-building properties and neighborhood common areas." },
                  { title: "Churches & Event Venues", desc: "Grand-scale installations for community gathering spaces." },
                ].map((item) => (
                  <div key={item.title} className="flex gap-4">
                    <div className="flex-shrink-0 mt-1">
                      <div className="w-8 h-8 rounded-full bg-gf-gold/20 flex items-center justify-center">
                        <svg className="w-4 h-4 text-gf-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
            ...
            <div className="relative">
              ...
              <div className="mt-6 grid grid-cols-3 gap-4 text-center">
                ...
                <div className="rounded-xl bg-white/5 border border-white/10 p-4">
                  ...
                  <span className="text-xs text-white/60">Design for Every Property</span>
                </div>
                <div className="rounded-xl bg-white/5 border border-white/10 p-4">
