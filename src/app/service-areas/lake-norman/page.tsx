    ...
    <main>
      ...
      <section className="relative bg-gf-red-dark px-4 py-20 sm:py-28 overflow-hidden">
        <div className="absolute inset-0">
          <Image
            src={img("/images/service-areas/lake-norman.jpg")}
            alt=""
            fill
            sizes="100vw"
        ...
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--color-gf-red-light)_0%,_transparent_60%)] opacity-30" />
